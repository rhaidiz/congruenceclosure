  ...
  String myArgs="";
    ...
    case 9:
      ...
      jj_consume_token(7);
                ...
                // Aggiungo questo cons nella lista dei cons da controllare per soddisfacibilitˆ
                consfn.add(myKey);
                // Adesso devo aggiungere questo nodo nel grafo (prima controllo se giˆ esiste)
    ...
    case FUN:
      ...
      jj_consume_token(7);
                ...
                /* Devo controllare che questa funzione con una arietˆ diversa non sia giˆ presente */
        ...
        /* Devo controllare se la funzione giˆ essite per evitare di sovrascriverla
    ...
    case ALPHA:
      a = jj_consume_token(ALPHA);
                // Quando incontro un terminale, se non  giˆ nel grafo allora lo aggiungo
